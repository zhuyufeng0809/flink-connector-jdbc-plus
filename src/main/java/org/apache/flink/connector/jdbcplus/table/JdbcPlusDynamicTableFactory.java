...
package org.apache.flink.connector.jdbcplus.table;

import org.apache.flink.annotation.Internal;
import org.apache.flink.configuration.ConfigOption;
import org.apache.flink.configuration.ConfigOptions;
import org.apache.flink.configuration.ReadableConfig;
import org.apache.flink.connector.jdbcplus.JdbcExecutionOptions;
import org.apache.flink.connector.jdbcplus.dialect.JdbcDialect;
import org.apache.flink.connector.jdbcplus.dialect.JdbcDialects;
import org.apache.flink.connector.jdbcplus.internal.options.JdbcConnectorOptions;
import org.apache.flink.connector.jdbcplus.internal.options.JdbcDmlOptions;
...
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.DRIVER;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.LOOKUP_CACHE_MAX_ROWS;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.LOOKUP_CACHE_TTL;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.LOOKUP_MAX_RETRIES;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.MAX_RETRY_TIMEOUT;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.PASSWORD;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_AUTO_COMMIT;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_FETCH_SIZE;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_PARTITION_COLUMN;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_PARTITION_LOWER_BOUND;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_PARTITION_NUM;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SCAN_PARTITION_UPPER_BOUND;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_INTERVAL;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_MAX_ROWS;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SINK_MAX_RETRIES;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.SINK_PARALLELISM;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.TABLE_NAME;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.URL;
import static org.apache.flink.connector.jdbcplus.table.JdbcConnectorOptions.USERNAME;
 ...
 */
@Internal
public class JdbcPlusDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
